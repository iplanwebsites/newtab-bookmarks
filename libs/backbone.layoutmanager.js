...
(function(window) {
    ...
    var LayoutManager = Backbone.View.extend({
            ...
            function resolve() {
                ...
                if (parent) {
                    if (!options.contains(parent.el, root.el)) {
                        options.partial(parent.el, manager.selector, root.el, manager.append);
                    }
                }
        ...
        setupView: function(view, options) {
            ...
            viewOptions = _.pick(options, aConcat.call(["events"], _.values(options.events)));
            ...
            if (viewOverrides.render === LayoutManager.prototype.render || viewOverrides.render === Backbone.View.prototype.render) {
